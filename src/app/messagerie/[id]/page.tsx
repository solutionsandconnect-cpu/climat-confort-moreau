                        ...
                        {msg.documentPdfList && msg.documentPdfList.length > 0 && (
                          <div className="mt-1 space-y-1">
                            {msg.documentPdfList.map((url, i) => (
                              <a key={i} href={url} target="_blank" rel="noopener noreferrer"
                                className={cn("flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-medium border", isMe ? "bg-white/20 text-white border-white/30" : "bg-primary-bg text-primary border-primary/20")}>
