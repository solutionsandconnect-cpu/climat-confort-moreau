        ...
        <div className="space-y-4">
          ...
          {categorie==="Demande autorisation absence"&&(
            <div className="card p-4 space-y-3">
              ...
              <div>
                <p className="text-xs text-secondary-text mt-1 flex items-center gap-1">1- N'oubliez pas de prendre en compte 5 samedis sur une année de congés payés. Il n'est pas possible de prendre le congé de fractionnement avant le congé principal.</p>
                <p className="text-xs text-secondary-text mt-1 flex items-center gap-1">2- Il est impératif de faire la demande au moins 15 jours avant la date demandée, sauf en cas de circonstances familiales particulières.</p>
              </div>
